...
struct ProductCatalog: View {
    ...
    var body: some View {
        ...
        return NavigationView {
            ...
            let category = BYCategoryAttributes(CategoryId: "", CategoryName: "\(products.count)", tags: ["Number_Product":"\(products.count)"])
            AppDelegate.instance.beyableClient.sendPageview(page: EPageUrlTypeBeyable.CATEGORY, currentView: self, attributes: category)
        }
