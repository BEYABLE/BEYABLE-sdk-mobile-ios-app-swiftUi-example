...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ app: UIApplication, open url: URL, options: [UIApplication.OpenURLOptionsKey : Any] = [:]) -> Bool {
        ...
        if url.scheme == "ExampleApplication" && url.host == "cart" {
            // Gérez l'URL "ExampleApplication://cart" ici
            // Par exemple, naviguez vers la vue de panier
        }
        return true
    }
    ...
    lazy var persistentContainer: NSPersistentContainer = {
        ...
        */
        let container = NSPersistentContainer(name: "BeyableExampleApplication")
